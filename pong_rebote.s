...
mov_bola:
    ...
    add a5, s7, s10         ## Agrega la direccion horizontal a la bola
    add a5, a5, s11         ## Agrega la direccion vertical a la bola
    beq a5, s5, rebote_h    ## Si la bola choca con psj1, su direccion cambia a la derecha
    beq a5, s6, rebote_h    ## Si la bola choca con psj2, su direccion cambia a la izquierda
    ...
    blt a5, a6, rebote_v    ## Si choca con limite superior, su direccion cambia hacia abajo
    li a6, 3500             ## Limite inferior
    bgt a5, a6, rebote_v    ## Si choca con limite inferior, su direccion cambia hacia abajo
    
    mv s7, a5               ## Copiar la palabra de direccion
